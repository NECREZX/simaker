...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!validateCSRFToken($_POST['csrf_token'])) {
        ...
        redirect(APP_URL . '/modules/medis/logbook/create.php');
    }
    ...
    if (empty($errors)) {
        ...
        $logbookId = insert('logbooks', $data);
        
        if ($logbookId) {
            logActivity($userId, 'CREATE', 'logbooks', $logbookId, 'Membuat logbook: ' . $activityTitle);
            setFlashMessage('Logbook berhasil ditambahkan! Status: Menunggu verifikasi.', 'success');
            redirect(APP_URL . '/modules/medis/logbook/index.php');
        } else {
            $errors[] = 'Gagal menyimpan logbook.';
        }
    }
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="bi bi-plus-circle"></i> Form Tambah Logbook Baru</h5>
    </div>
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="activity_title" name="activity_title" 
                       placeholder="Contoh: Perawatan Pasien Trauma" required maxlength="200">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="activity_description" name="activity_description" 
                          rows="5" required placeholder="Jelaskan detail aktivitas yang dilakukan..."></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label for="evidence" class="form-label">Bukti/Foto (Opsional)</label>
            ...
            <div class="alert alert-info">
                ...
                <ul class="mb-0 mt-2">
                    <li>Logbook akan berstatus "Pending" menunggu verifikasi dari supervisor</li>
                    <li>Anda dapat mengedit logbook selama status masih "Pending"</li>
