...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    if (!validateCSRFToken($_POST['csrf_token'])) {
        ...
        redirect(APP_URL . '/modules/medis/profile.php');
    }
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= escapeHtml($user['unit_name']) ?>" disabled>
                    </div>
                    
                    <button type="submit" name="update_profile" class="btn btn-emerald">
        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                <div class="text-start">
                    ...
                    <p><strong>Unit:</strong><br><?= escapeHtml($user['unit_name']) ?></p>
